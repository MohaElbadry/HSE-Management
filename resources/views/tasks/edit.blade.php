    ...
    <form class="mt-8 space-y-6 bg-gray-100 p-4 border-gray-200 shadow-xl  rounded-xl "
        ...
        <div class="relative">
            ...
            <input
                ...
                name="lib" placeholder="Libellet" value="{{ $task->lib }}">
        </div>
        <div class="mt-8 content-center">
            ...
            <input
                ...
                name="description" placeholder="Enter The Description" value="{{ $task->description }}">
        </div>
        <div class="mt-8 content-center">
            <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                task_start
            ...
            <input
                class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500"
                name="task_start" placeholder="Enter The Description" value="{{ $task->task_start }}">
        </div>
        <div class="mt-8 content-center">
            <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                description
            ...
            <input
                class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500"
                name="task_end" placeholder="Enter The Description" value="{{ $task->task_end }}">
        </div>
