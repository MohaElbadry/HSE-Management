...
<div class="flex h-full  pt-3 items-center justify-center bg-white text-center text-5xl font-bold shadow-md">
    ...
    <form class="mt-8 space-y-6 bg-gray-100 p-4 border-gray-200 shadow-xl  rounded-xl "
        action="{{ route('documents.update', $document->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="relative">
            ...
            <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Title</label>
            <input
                class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500"
                name="titre" placeholder="Libellet" value="{{ $document->titre }}">
        </div>
        <div class="mt-8 content-center">
            ...
            <input
                ...
                name="description" placeholder="Enter The Description" value="{{ $document->description }}">
        </div>
