...
<div class="flex h-full  pt-3 items-center justify-center bg-white text-center text-5xl font-bold shadow-md">
    ...
    <!-- component -->
    @csrf
    <form class="mt-2 h-fit space-y-6 bg-gray-200 p-4 rounded-xl border-black" action="{{ route('documents.store') }}"
        ...
        <div class="relative">
            ...
            <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">titre</label>
            <input
        ...
        <div class="mt-2 content-center">
            ...
            <input
                class="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500"
                name="fichier" placeholder="Enter Une sate" type="file">
        </div>
