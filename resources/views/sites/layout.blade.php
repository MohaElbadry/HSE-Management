...
<body>
    <div class="flex min-h-screen flex-row  bg-[#f6f6f6] text-gray-800">
        ...
        <main class="main -ml-48 flex flex-grow flex-col p-4 transition-all duration-150 ease-in md:ml-0">
            <div
                class="flex h-full bg-viollet-300  pt-3 justify-center bg-white text-center text-5xl font-bold shadow-md">
                <!-- component -->
                @yield('content')
