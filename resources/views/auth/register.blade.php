        ...
        <div class="flex justify-center px-6 my-12">
            ...
            <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                ...
                <div class="w-full lg:w-7/12 bg-gray-50 p-5  shadow-xl   rounded-lg lg:rounded-l-none">
                    ...
                    <form method="POST" class="px-8 pt-6 pb-8 mb-4 bg-gray-50 rounded" action="{{ route('register') }}">
                        @csrf
                        ...
                        <div class="mb-4 md:flex md:justify-between">
                            ...
                            <div class="md:ml-2">
                                ...
                                <input id="password-confirm" type="password"
                                    class="w-full px-3 py-2 mb-3 text-sm form-control leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
