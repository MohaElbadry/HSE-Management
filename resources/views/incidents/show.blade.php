      ...
      <div class="flex h-full  pt-3 justify-center bg-white text-center text-5xl font-bold shadow-md">
        ...
        <div class="card">
          ...
          <div class="card__content">
            <h2 class="text-gray-400 text-3xl font-semibold mb-2">Name : {{ $incident->lib }}</h2>
            <p class="mt-2 text-white text-xl text-start p-3"> {{ $incident->description }}
            <p class="mt-2 text-gray-300 text-xl text-end p-3"> {{ $incident->created_at }}
            </p>
          </div>
        </div>
